...
public class HospitalTest {
    ...
    Hospital underTest = new Hospital();    //hospital underTest object with collection in it
    ...
    public void shouldBeAbleToHireADoctor() {
       ...
       HospitalEmployee foundDoctor = underTest.findEmployee("1");          //trying to find doctor
        assertEquals("doctor name", foundDoctor.getName());
    }

    @Test
    public void shouldBeAbleToHireADoctorANurseAndJanitor() {
        underTest.hire(doctor);
